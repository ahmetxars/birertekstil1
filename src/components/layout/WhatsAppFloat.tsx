...
export default function WhatsAppFloat({ whatsappNumber }: WhatsAppFloatProps) {
  ...
  return (
    <TrackedExternalLink
      ...
      leadType="whatsapp"
      leadLabel="floating_whatsapp"
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full text-white shadow-lg animate-whatsapp-pulse transition-transform hover:scale-110"
      style={{ backgroundColor: '#25D366' }}
      aria-label="WhatsApp ile fiyat sor"
    >
